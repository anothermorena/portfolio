export const projects = [
  ...
  },
  {
    ...
    description:
      "Another end-to-end PWA and a machine learning (linear regression) project to predict the medical insurance cost of a person. The model yielded an R2 score of 0.79",
    image: "/images/4.png",
    tags: ["React", "Python", "FastAPI", "Sklearn"],
  ...
  },
  {
    ...
    description:
      "This was a scholarship application portal. I recruited like-minded Batswana and established an NGO, developed its website and social platforms. We sought to help Batswana get international scholarships and managed to help several students win fully funded scholarships.",
    image: "/images/6.png",
    tags: ["HTML", "Materialize CSS", "jQuery", "PHP", "MySQL"],
    code: "https://github.com/anothermorena/Ithute-Motswana",
    live: "http://ithutemotswana.com/",
    id: 5,
  },
];
...
export const TimeLineData = [
  {
    year: 2024,
    text: "Founder, CEO and Lead Engineer at AiGeniX.",
  },
  {
    year: 2023,
    text: "Started my Technical Lead role at Weblogic Botswana.",
  },
  {
    year: 2021,
    text: "Got a Masters degree in Biomedical Engineering specializing in Bioinformatics and Machine Learning.",
  },
  { year: 2018, text: "Started my CTO role at Toro Clinic." },
  { year: 2018, text: "Got a Bachelors degree in Clinical Informatics." },
  {
    year: 2016,
    text: "Got an information technology internship at Always Open Clinic.",
  },
